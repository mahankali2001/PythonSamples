...
file_path1 = '../data/logfile_01_06_2025.csv'
...
file_path2 = '../data/logfile_01_07_2025.csv'
...
print(f"Customer count who visited minimum 1 page: {customer_total_urls_df_count}")
